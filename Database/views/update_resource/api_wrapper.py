...
def api_wrapper(*args, **kwargs):
    ...
    resource_dict = interactor.update_resources(
        user_id=user_id,
    ...
    """
    try:
        from resource_management.views.update_resource.tests.test_case_01 \
    ...
    try:
        from resource_management.views.update_resource.request_response_mocks \

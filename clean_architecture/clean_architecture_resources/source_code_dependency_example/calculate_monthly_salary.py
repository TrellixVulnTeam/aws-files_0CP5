...
def calculate_monthly_salary():
    ...
    from source_code_dependency_example.employees.business_developer import \
        BusinessDeveloper
    ...
    business_developer_1 = BusinessDeveloper('Naveen', 20, 30000)

    all_employees = [developer_1, developer_2, designer_1, designer_2, business_developer_1]
